		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  /* call BLAS_stbsv */
			  FPU_FIX_STOP;
			  BLAS_stbsv(order_type, uplo_type, trans_type,
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  /* call BLAS_dtbsv */
			  FPU_FIX_STOP;
			  BLAS_dtbsv(order_type, uplo_type, trans_type,
				     diag_type, n, k, alpha, T, ldt, x,
				     incx_unadj);
			  FPU_FIX_START;
			  test_count++;
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  /* call BLAS_ctbsv */
			  FPU_FIX_STOP;
			  BLAS_ctbsv(order_type, uplo_type, trans_type,
				     diag_type, n, k, alpha, T, ldt, x,
				     incx_unadj);
			  FPU_FIX_START;
			  test_count++;
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (ldt_val = 0; ldt_val < 3; ldt_val++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  /* call BLAS_ztbsv */
			  FPU_FIX_STOP;
			  BLAS_ztbsv(order_type, uplo_type, trans_type,
				     diag_type, n, k, alpha, T, ldt, x,
				     incx_unadj);
			  FPU_FIX_START;
			  test_count++;
			  ...
			  for (j = 0; j < n; j++) {
			    if (j == row) {
			      double minus_one[2] = { -1.0, 0.0 };
			      /* copy row j of T to temp */
			      ztbsv_copy(order_type, uplo_type, trans_type, n,
					 k, T, ldt, temp, j);
...
int main(int argc, char **argv)
{
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_stbsv(n, ntests, &seed, thresh, debug,
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtbsv(n, ntests, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctbsv(n, ntests, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztbsv(n, ntests, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
