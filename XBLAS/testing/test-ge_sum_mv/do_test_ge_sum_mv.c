...
void do_test_sge_sum_mv
  ...
  /* Function name */
  const char fname[] = "BLAS_sge_sum_mv";
		...
		for (randomize_val = RANDOMIZE_START;
		  ...
		  for (incx_val = INCX_START; incx_val <= INCX_END;
			...
			continue;
		      ...
		      FPU_FIX_STOP;
		      BLAS_sge_sum_mv(order_type,
				      m, n, alpha, a, lda, x, incx, beta, B,
				      ldb, y, incy);
		      FPU_FIX_START;
...
void do_test_dge_sum_mv
  (int m, int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_dge_sum_mv";
...
void do_test_cge_sum_mv
  (int m, int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_cge_sum_mv";
...
void do_test_zge_sum_mv
  (int m, int n,
   int ntests, int *seed, double thresh, int debug, float test_prob,
   double *min_ratio, double *max_ratio, int *num_bad_ratio, int *num_tests) {

  /* Function name */
  const char fname[] = "BLAS_zge_sum_mv";
