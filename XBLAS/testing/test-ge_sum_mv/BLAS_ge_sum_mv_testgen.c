 ...
 */
{
  ...
  if (randomize == 0) {
	...
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  sge_sum_mv_copy(order, m_i, n_i, b, ldb, a_vec, i);
	...
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  sge_sum_mv_copy(order, m_i, n_i, a, lda, a_vec, i);
 ...
 */
{
  ...
  if (randomize == 0) {
	...
	/* Fill in truth from b, beta_i only */
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  dge_sum_mv_copy(order, m_i, n_i, b, ldb, a_vec, i);
	...
	/* Fill in truth from a, alpha_i only */
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  dge_sum_mv_copy(order, m_i, n_i, a, lda, a_vec, i);
 ...
 */
{
  ...
  if (randomize == 0) {
	...
	/* Fill in truth from b, beta_i only */
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  cge_sum_mv_copy(order, m_i, n_i, b, ldb, a_vec, i);
	...
	/* Fill in truth from a, alpha_i only */
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  cge_sum_mv_copy(order, m_i, n_i, a, lda, a_vec, i);
 ...
 */
{
  ...
  if (randomize == 0) {
	...
	/* Fill in truth from b, beta_i only */
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  zge_sum_mv_copy(order, m_i, n_i, b, ldb, a_vec, i);
	...
	/* Fill in truth from a, alpha_i only */
	for (i = 0, ri = 0; i < m_i; i++, ri += incri) {
	  zge_sum_mv_copy(order, m_i, n_i, a, lda, a_vec, i);
