		...
		for (incy_val = -2; incy_val <= 2; incy_val++) {
		  ...
		  if (!(ratio <= thresh)) {
			...
			printf("x[%d]=%.8e, x[%d]=%.8e", ix, x[ix], ix + 1,
			       x[ix + 1]);
			printf("\n      ");
			printf("y[%d]=%.8e, y[%d]=%.8e", iy, y[iy], iy + 1,
			       y[iy + 1]);
			printf("\n");
		...
		for (incy_val = -2; incy_val <= 2; incy_val++) {
		  ...
		  if (!(ratio <= thresh)) {
			...
			iy = -(n - 1) * incy;
		      ...
		      for (j = 0; j < n; j++) {
			printf("      ");
			printf("x[%d]=%.16e, x[%d]=%.16e", ix, x[ix], ix + 1,
			       x[ix + 1]);
			printf("\n      ");
			printf("y[%d]=%.16e, y[%d]=%.16e", iy, y[iy], iy + 1,
			       y[iy + 1]);
			printf("\n");
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_sdot_x */

double do_test_ddot_x(int n,
		      int ntests,
		      int *seed,
		      double thresh,
		      int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_ddot_x */

double do_test_cdot_x(int n,
		      int ntests,
		      int *seed,
		      double thresh,
		      int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_cdot_x */

double do_test_zdot_x(int n,
		      int ntests,
		      int *seed,
		      double thresh,
		      int debug,
 ...
 */
{
		  ...
		  for (incy_val = -2; incy_val <= 2; incy_val++) {
			...
			for (j = 0; j < n; j++) {
			  ...
			  printf("x[%d]=%.16e, x[%d]=%.16e", ix, x[ix],
				 ix + 1, x[ix + 1]);
			  printf("\n      ");
			  printf("y[%d]=%.16e, y[%d]=%.16e", iy, y[iy],
				 iy + 1, y[iy + 1]);
			  printf("\n");
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_x */

double do_test_ddot_s_s(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_ddot_s_s */

double do_test_ddot_s_d(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_ddot_s_d */

double do_test_ddot_d_s(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_ddot_d_s */

double do_test_cdot_s_s(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_cdot_s_s */

double do_test_cdot_s_c(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_cdot_s_c */

double do_test_cdot_c_s(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_cdot_c_s */

double do_test_zdot_c_c(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_c_c */

double do_test_zdot_c_z(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_c_z */

double do_test_zdot_z_c(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_z_c */

double do_test_zdot_d_d(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_d_d */

double do_test_zdot_z_d(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_z_d */

double do_test_zdot_d_z(int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_d_z */

double do_test_ddot_s_s_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_ddot_s_s_x */

double do_test_ddot_s_d_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_ddot_s_d_x */

double do_test_ddot_d_s_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_ddot_d_s_x */

double do_test_cdot_s_s_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_cdot_s_s_x */

double do_test_cdot_s_c_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_cdot_s_c_x */

double do_test_cdot_c_s_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_cdot_c_s_x */

double do_test_zdot_c_c_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_c_c_x */

double do_test_zdot_c_z_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_c_z_x */

double do_test_zdot_z_c_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_z_c_x */

double do_test_zdot_d_d_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_d_d_x */

double do_test_zdot_d_z_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  ...
  FPU_FIX_STOP;
  return ratio_max;
}				/* end of do_test_zdot_d_z_x */

double do_test_zdot_z_d_x(int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
...
int main(int argc, char **argv)
{
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_sdot(n, ntests, &seed, thresh, debug, test_prob,
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_ddot(n, ntests, &seed, thresh, debug, test_prob,
				   &total_min_ratio, &num_bad_ratio,
				   &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_cdot(n, ntests, &seed, thresh, debug, test_prob,
				   &total_min_ratio, &num_bad_ratio,
				   &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_zdot(n, ntests, &seed, thresh, debug, test_prob,
				   &total_min_ratio, &num_bad_ratio,
				   &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
