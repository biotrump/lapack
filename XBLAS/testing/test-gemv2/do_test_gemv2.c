...
double do_test_sgemv2(int m, int n,
		      int ntests,
		      int *seed,
		      double thresh,
		      int debug,
 ...
 */
{
  ...
  *min_ratio = 0.0;
  ...
  if (max_mn * 2 * incx_gen > 0 && head_x == NULL) {
    printf("malloc failed\n");
    exit(-1);
  }
  tail_x = (float *) blas_malloc(max_mn * 2 * incx_gen * sizeof(float));
  ...
  ratios = (double *) malloc(max_mn * sizeof(double));
  if (ratios == NULL) {
    printf("malloc failed\n");
    exit(-1);
  }
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  if (m > 0 && n > 0)
		    BLAS_sgemv2_testgen(norm, order_type, trans_type,
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
		    ...
		    for (j = 0; j < n_i * incx_gen; j += incx_gen) {
		      head_x[ix] = head_x_gen[j];
		      tail_x[ix] = tail_x_gen[j];
		      ix += incx;
		    }
			...
			iy += incy;
		      ...
		      /* call BLAS_sgemv2 */
		      FPU_FIX_STOP;
		      BLAS_sgemv2(order_type, trans_type, m, n, alpha, A,
				  lda, head_x, tail_x, incx_val, beta,
				  y, incy_val);
		      FPU_FIX_START;
			...
			for (j = 0, k = 0; j < m_i; j++, k += incy_gen) {
			  ...
			  sgemv2_copy(order_type, trans_type, m, n, A, lda,
				      temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_sgemv2 */

double do_test_dgemv2(int m, int n,
		      int ntests,
		      int *seed,
		      double thresh,
		      int debug,
 ...
 */
{
  ...
  *min_ratio = 0.0;
  ...
  tail_x = (double *) blas_malloc(max_mn * 2 * incx_gen * sizeof(double));
  if (max_mn * 2 * incx_gen > 0 && tail_x == NULL) {
    printf("malloc failed\n");
    exit(-1);
  }
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_dgemv2_testgen(norm, order_type, trans_type,
					m, n, &alpha, alpha_flag, A, lda,
					head_x_gen, tail_x_gen, &beta,
					beta_flag, y_gen, seed,
					head_r_true, tail_r_true);
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
			...
			iy += incy;
		      ...
		      /* call BLAS_dgemv2 */
		      FPU_FIX_STOP;
		      BLAS_dgemv2(order_type, trans_type, m, n, alpha, A,
				  lda, head_x, tail_x, incx_val, beta,
				  y, incy_val);
		      FPU_FIX_START;
			...
			for (j = 0, k = 0; j < m_i; j++, k += incy_gen) {
			  /* copy row j of A to temp */
			  dgemv2_copy(order_type, trans_type, m, n, A, lda,
				      temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2 */

double do_test_cgemv2(int m, int n,
		      int ntests,
		      int *seed,
		      double thresh,
		      int debug,
 ...
 */
{
  ...
  *min_ratio = 0.0;
  ...
  tail_x = (float *) blas_malloc(max_mn * 2 * incx_gen * sizeof(float) * 2);
  if (max_mn * 2 * incx_gen > 0 && tail_x == NULL) {
    printf("malloc failed\n");
    exit(-1);
  }
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_cgemv2_testgen(norm, order_type, trans_type,
					m, n, &alpha, alpha_flag, A, lda,
					head_x_gen, tail_x_gen, &beta,
					beta_flag, y_gen, seed,
					head_r_true, tail_r_true);
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
		    ...
		    for (j = 0; j < n_i * incx_gen; j += incx_gen) {
		      head_x[ix] = head_x_gen[j];
		      head_x[ix + 1] = head_x_gen[j + 1];
		      tail_x[ix] = tail_x_gen[j];
		      tail_x[ix + 1] = tail_x_gen[j + 1];
		      ix += incx;
		    }
			...
			iy += incy;
		      ...
		      /* call BLAS_cgemv2 */
		      FPU_FIX_STOP;
		      BLAS_cgemv2(order_type, trans_type, m, n, alpha, A,
				  lda, head_x, tail_x, incx_val, beta,
				  y, incy_val);
		      FPU_FIX_START;
			...
			for (j = 0, k = 0; j < m_i; j++, k += incy_gen) {
			  /* copy row j of A to temp */
			  cgemv2_copy(order_type, trans_type, m, n, A, lda,
				      temp, j);
			...
			if ((debug == 3) &&	/* print only when debug is on */
			  ...
			  for (j = 0, k = 0; j < n_i || k < m_i; j++, k++) {
			    if (j < n_i) {
			      printf("      ");
			      printf("head_x[%d]=%.8e, head_x[%d]=%.8e", ix,
				     head_x[ix], ix + 1, head_x[ix + 1]);
			      printf("\n");
			      printf("      ");
			      printf("tail_x[%d]=%.8e, tail_x[%d]=%.8e", ix,
				     tail_x[ix], ix + 1, tail_x[ix + 1]);
			      printf("\n");
			    }
			    if (k < m_i) {
			      printf("      ");
			      printf("y_gen[%d]=%.8e, y_gen[%d]=%.8e",
			  ...
			  for (j = 0, k = 0; j < m_i * incy_gen;
			    ...
			    printf("      ");
			    printf
			      ("head_r_true[%d][0]=%.16e, head_r_true[%d][1]=%.16e,\n      tail_r_true[%d][0]=%.16e, tail_r_true[%d][1]=%.16e",
			       j, head_r_true[j], j, head_r_true[j + 1], j,
			       tail_r_true[j], j, tail_r_true[j + 1]);
			    printf(", ratio[%d]=%.4e\n", k, ratios[k]);
			  }
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2 */

double do_test_zgemv2(int m, int n,
		      int ntests,
		      int *seed,
		      double thresh,
		      int debug,
 ...
 */
{
  ...
  *min_ratio = 0.0;
  ...
  tail_x = (double *) blas_malloc(max_mn * 2 * incx_gen * sizeof(double) * 2);
  if (max_mn * 2 * incx_gen > 0 && tail_x == NULL) {
    printf("malloc failed\n");
    exit(-1);
  }
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_zgemv2_testgen(norm, order_type, trans_type,
					m, n, &alpha, alpha_flag, A, lda,
					head_x_gen, tail_x_gen, &beta,
					beta_flag, y_gen, seed,
					head_r_true, tail_r_true);
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
			...
			iy += incy;
		      ...
		      /* call BLAS_zgemv2 */
		      FPU_FIX_STOP;
		      BLAS_zgemv2(order_type, trans_type, m, n, alpha, A,
				  lda, head_x, tail_x, incx_val, beta,
				  y, incy_val);
		      FPU_FIX_START;
			...
			for (j = 0, k = 0; j < m_i; j++, k += incy_gen) {
			  /* copy row j of A to temp */
			  zgemv2_copy(order_type, trans_type, m, n, A, lda,
				      temp, j);
			...
			if ((debug == 3) &&	/* print only when debug is on */
			  ...
			  for (j = 0, k = 0; j < n_i || k < m_i; j++, k++) {
			    if (j < n_i) {
			      printf("      ");
			      printf("head_x[%d]=%.16e, head_x[%d]=%.16e", ix,
				     head_x[ix], ix + 1, head_x[ix + 1]);
			      printf("\n");
			      printf("      ");
			      printf("tail_x[%d]=%.16e, tail_x[%d]=%.16e", ix,
				     tail_x[ix], ix + 1, tail_x[ix + 1]);
			      printf("\n");
			    }
			    if (k < m_i) {
			      printf("      ");
			      printf("y_gen[%d]=%.16e, y_gen[%d]=%.16e",
				     k * incy_gen, y_gen[k * incy_gen],
				     k * incy_gen + 1,
				     y_gen[k * incy_gen + 1]);
			      printf("\n");
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2 */

double do_test_dgemv2_s_s(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_dgemv2_s_s_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2_s_s */

double do_test_dgemv2_s_d(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_dgemv2_s_d_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2_s_d */

double do_test_dgemv2_d_s(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_dgemv2_d_s_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2_d_s */

double do_test_zgemv2_c_c(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_zgemv2_c_c_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_c_c */

double do_test_zgemv2_c_z(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_zgemv2_c_z_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_c_z */

double do_test_zgemv2_z_c(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_zgemv2_z_c_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_z_c */

double do_test_cgemv2_s_s(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_cgemv2_s_s_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2_s_s */

double do_test_cgemv2_s_c(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_cgemv2_s_c_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2_s_c */

double do_test_cgemv2_c_s(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_cgemv2_c_s_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2_c_s */

double do_test_zgemv2_d_d(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_zgemv2_d_d_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_d_d */

double do_test_zgemv2_z_d(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_zgemv2_z_d_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_z_d */

double do_test_zgemv2_d_z(int m, int n,
			  int ntests,
			  int *seed,
			  double thresh,
			  int debug,
 ...
 */
{
	...
	for (norm = -1; norm <= 1; norm++) {
	  ...
	  for (i = 0; i < ntests; i++) {
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  /* in the trivial cases, no need to run testgen */
		  if (m > 0 && n > 0)
		    BLAS_zgemv2_d_z_testgen(norm, order_type, trans_type,
					    m, n, &alpha, alpha_flag, A, lda,
					    head_x_gen, tail_x_gen, &beta,
					    beta_flag, y_gen, seed,
					    head_r_true, tail_r_true);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_d_z */

double do_test_sgemv2_x(int m, int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			if (!(ratio <= thresh)) {
			  ...
			  if ((debug == 3) &&	/* print only when debug is on */
			    ...
			    for (j = 0; j < m_i; j++) {
			      /* copy row j of A to temp */
			      sgemv2_copy(order_type, trans_type, m, n, A,
					  lda, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_sgemv2_x */

double do_test_dgemv2_x(int m, int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			if (!(ratio <= thresh)) {
			  ...
			  if ((debug == 3) &&	/* print only when debug is on */
			    ...
			    for (j = 0; j < m_i; j++) {
			      /* copy row j of A to temp */
			      dgemv2_copy(order_type, trans_type, m, n, A,
					  lda, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2_x */

double do_test_cgemv2_x(int m, int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			if (!(ratio <= thresh)) {
			  ...
			  if ((debug == 3) &&	/* print only when debug is on */
			    ...
			    for (j = 0; j < m_i; j++) {
			      /* copy row j of A to temp */
			      cgemv2_copy(order_type, trans_type, m, n, A,
					  lda, temp, j);
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2_x */

double do_test_zgemv2_x(int m, int n,
			int ntests,
			int *seed,
			double thresh,
			int debug,
 ...
 */
{
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			if (!(ratio <= thresh)) {
			  ...
			  if ((debug == 3) &&	/* print only when debug is on */
			    ...
			    for (j = 0; j < m_i; j++) {
			      /* copy row j of A to temp */
			      zgemv2_copy(order_type, trans_type, m, n, A,
					  lda, temp, j);
			    ...
			    for (j = 0, k = 0; j < n_i || k < m_i; j++, k++) {
			      if (j < n_i) {
				printf("      ");
				printf("head_x[%d]=%.16e, head_x[%d]=%.16e",
				       ix, head_x[ix], ix + 1,
				       head_x[ix + 1]);
				printf("\n");
				printf("      ");
				printf("tail_x[%d]=%.16e, tail_x[%d]=%.16e",
				       ix, tail_x[ix], ix + 1,
				       tail_x[ix + 1]);
				printf("\n");
			      }
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_x */


double do_test_dgemv2_s_s_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
	  ...
	  for (norm = -1; norm <= 1; norm++) {
		...
		for (trans_val = 0; trans_val < 3; trans_val++) {
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
		    ...
		    if (m > 0 && n > 0)
		      BLAS_dgemv2_s_s_testgen(norm, order_type, trans_type,
					      m, n, &alpha, alpha_flag, A,
					      lda, head_x_gen, tail_x_gen,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2_s_s_x */

double do_test_dgemv2_s_d_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2_s_d_x */

double do_test_dgemv2_d_s_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv2_d_s_x */

double do_test_zgemv2_c_c_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_c_c_x */

double do_test_zgemv2_c_z_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_c_z_x */

double do_test_zgemv2_z_c_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_z_c_x */

double do_test_cgemv2_s_s_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2_s_s_x */

double do_test_cgemv2_s_c_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2_s_c_x */

double do_test_cgemv2_c_s_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv2_c_s_x */

double do_test_zgemv2_d_d_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_d_d_x */

double do_test_zgemv2_d_z_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
 ...
 */
{
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_zgemv2_d_z_x */

double do_test_zgemv2_z_d_x(int m, int n,
			    int ntests,
			    int *seed,
			    double thresh,
			    int debug,
...
int main(int argc, char **argv)
{
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_sgemv2(m, n, 1, &seed, thresh, debug,
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2(m, n, 1, &seed, thresh, debug,
				     test_prob, &total_min_ratio,
				     &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2(m, n, 1, &seed, thresh, debug,
				     test_prob, &total_min_ratio,
				     &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2(m, n, 1, &seed, thresh, debug,
				     test_prob, &total_min_ratio,
				     &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2_s_s(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2_s_d(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2_d_s(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_c_c(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_c_z(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_z_c(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2_s_s(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2_s_c(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2_c_s(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_d_d(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_z_d(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_d_z(m, n, 1, &seed, thresh, debug,
					 test_prob, &total_min_ratio,
					 &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_sgemv2_x(m, n, 1, &seed, thresh, debug,
				       test_prob, &total_min_ratio,
				       &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2_x(m, n, 1, &seed, thresh, debug,
				       test_prob, &total_min_ratio,
				       &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2_x(m, n, 1, &seed, thresh, debug,
				       test_prob, &total_min_ratio,
				       &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_x(m, n, 1, &seed, thresh, debug,
				       test_prob, &total_min_ratio,
				       &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2_s_s_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2_s_d_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv2_d_s_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_c_c_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_c_z_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_z_c_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2_s_s_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2_s_c_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv2_c_s_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_d_d_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_d_z_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv2_z_d_x(m, n, 1, &seed, thresh, debug,
					   test_prob, &total_min_ratio,
					   &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
