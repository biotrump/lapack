...
double do_test_sgemv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
 ...
 */
{
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
			...
			iy += incy;
		      ...
		      /* call BLAS_sgemv */
		      FPU_FIX_STOP;
		      BLAS_sgemv(order_type, trans_type, m, n, alpha, A,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_sgemv */

double do_test_dgemv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
 ...
 */
{
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
			...
			iy += incy;
		      ...
		      /* call BLAS_dgemv */
		      FPU_FIX_STOP;
		      BLAS_dgemv(order_type, trans_type, m, n, alpha, A,
				 lda, x, incx_val, beta, y, incy_val);
		      FPU_FIX_START;
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dgemv */

double do_test_cgemv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
 ...
 */
{
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
			...
			iy += incy;
		      ...
		      /* call BLAS_cgemv */
		      FPU_FIX_STOP;
		      BLAS_cgemv(order_type, trans_type, m, n, alpha, A,
				 lda, x, incx_val, beta, y, incy_val);
		      FPU_FIX_START;
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_cgemv */

double do_test_zgemv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
		...
		for (lda_val = 0; lda_val < 3; lda_val++) {
		  ...
		  for (incx_val = -2; incx_val <= 2; incx_val++) {
			...
			iy += incy;
		      ...
		      /* call BLAS_zgemv */
		      FPU_FIX_STOP;
		      BLAS_zgemv(order_type, trans_type, m, n, alpha, A,
				 lda, x, incx_val, beta, y, incy_val);
		      FPU_FIX_START;
...
int main(int argc, char **argv)
{
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_sgemv(m, n, 1, &seed, thresh, debug,
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgemv(m, n, 1, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgemv(m, n, 1, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgemv(m, n, 1, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
