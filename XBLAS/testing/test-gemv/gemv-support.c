...
void sgemv_commit(enum blas_order_type order,
...
void sgemv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n,
		float *A, int lda, float *y, int row)
{
  int i;
...
void dgemv_commit(enum blas_order_type order,
		  enum blas_trans_type trans, int m, int n,
...
void dgemv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n,
		double *A, int lda, double *y, int row)
{
  int i;
...
void cgemv_commit(enum blas_order_type order,
		  enum blas_trans_type trans, int m, int n,
...
void cgemv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n,
		void *A, int lda, void *y, int row)
{
  int i;
...
void zgemv_commit(enum blas_order_type order,
		  enum blas_trans_type trans, int m, int n,
		  void *A, int lda, void *y, int row)
{
  int i;
...
void zgemv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n,
		void *A, int lda, void *y, int row)
{
  int i;
