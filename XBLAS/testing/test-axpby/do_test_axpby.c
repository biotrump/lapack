...
int main(int argc, char **argv)
{
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_saxpby(n, ntests, &seed, thresh, debug,
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_daxpby(n, ntests, &seed, thresh, debug,
				     &total_min_ratio, &num_bad_ratio,
				     &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_caxpby(n, ntests, &seed, thresh, debug,
				     &total_min_ratio, &num_bad_ratio,
				     &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (n = 0; n <= nsizes; n++) {
    ...
    total_max_ratio = do_test_zaxpby(n, ntests, &seed, thresh, debug,
				     &total_min_ratio, &num_bad_ratio,
				     &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
