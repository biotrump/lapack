...
void sgbmv_prepare(enum blas_order_type order,
...
/* SET ALL VALUES OF Y TO  = 0.0; */
  ...
  for (i = 0; i < (*ysize) * inc; i++) {
    y_i[i] = 0.0;
  }
}
void sgbmv_commit(enum blas_order_type order,
		  enum blas_trans_type trans, int m, int n, int kl, int ku,
		  float *AB, int lda, float *y, int row)
{
  int i, j;
...
void sgbmv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n, int kl, int ku,
...
void dgbmv_prepare(enum blas_order_type order,
		   enum blas_trans_type trans, int m, int n, int kl, int ku,
...
void dgbmv_commit(enum blas_order_type order,
		  enum blas_trans_type trans, int m, int n, int kl, int ku,
		  double *AB, int lda, double *y, int row)
{
  int i, j;
...
void dgbmv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n, int kl, int ku,
...
void cgbmv_prepare(enum blas_order_type order,
		   enum blas_trans_type trans, int m, int n, int kl, int ku,
...
void cgbmv_commit(enum blas_order_type order,
		  enum blas_trans_type trans, int m, int n, int kl, int ku,
		  void *AB, int lda, void *y, int row)
{
  int i, j;
...
void cgbmv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n, int kl, int ku,
...
void zgbmv_prepare(enum blas_order_type order,
		   enum blas_trans_type trans, int m, int n, int kl, int ku,
		   void *AB, int lda, void *y, int row,
		   int *nfix2, int *nmix, int *ysize)
{
...
void zgbmv_commit(enum blas_order_type order,
		  enum blas_trans_type trans, int m, int n, int kl, int ku,
		  void *AB, int lda, void *y, int row)
{
  int i, j;
...
void zgbmv_copy(enum blas_order_type order,
		enum blas_trans_type trans, int m, int n, int kl, int ku,
		const void *AB, int lda, void *y, int row)
{
  int i, j;
