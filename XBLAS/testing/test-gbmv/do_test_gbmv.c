...
double do_test_sgbmv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
 ...
 */
{
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_sgbmv_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_sgbmv_testgen */
  int order_val;
  enum blas_order_type order_type = 0;

  enum blas_prec_type prec_type = 0;
  int trans_val;
  ...
  *num_tests = 0;
  ...
  for (i = 0; i < max_mn * 2 * incx_gen; i += incx_gen) {
    x[i] = 0.0;
  }
  ...
  for (i = 0; i < max_mn * 2 * incy_gen; i += incy_gen) {
    y[i] = 0.0;
  }
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			for (incy_val = -2; incy_val <= 2; incy_val++) {
			  ...
			  /* call BLAS_sgbmv */
			  FPU_FIX_STOP;
			  BLAS_sgbmv(order_type, trans_type, m, n, kl, ku,
			  ...
			  for (j = 0; j < m_i; j++) {
			    ...
			    test_BLAS_sdot(n_i, blas_no_conj,
					   alpha, beta, y_gen[j * incy_gen],
					   y[iy], head_r_true[j * incy_gen],
					   tail_r_true[j * incy_gen], temp, 1,
					   x, incx_val, eps_int, un_int,
					   &ratios[j]);
			  ...
			  if (!(ratio <= thresh)) {
				...
				printf
				  ("head_r_true[%d]=%.16e, tail_r_true[%d]=%.16e",
				   j * incy_gen, head_r_true[j * incy_gen],
				   j * incy_gen, tail_r_true[j * incy_gen]);
				printf(", ratio[%d]=%.4e\n", j, ratios[j]);
			      }
...
{
  /* function name */
  const char fname[] = "BLAS_dgbmv_s_s";
  ...
  double *head_r_true, *tail_r_true;
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_dgbmv_s_s_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_dgbmv_s_s_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_dgbmv_s_s_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
...
{
  /* function name */
  const char fname[] = "BLAS_dgbmv_s_s_x";
...
{
  /* function name */
  const char fname[] = "BLAS_dgbmv_s_d";
  ...
  double *head_r_true, *tail_r_true;
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_dgbmv_s_d_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_dgbmv_s_d_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_dgbmv_s_d_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
...
{
  /* function name */
  const char fname[] = "BLAS_dgbmv_s_d_x";
...
{
  /* function name */
  const char fname[] = "BLAS_dgbmv_d_s";
  ...
  double *head_r_true, *tail_r_true;
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_dgbmv_d_s_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_dgbmv_d_s_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_dgbmv_d_s_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
...
{
  /* function name */
  const char fname[] = "BLAS_dgbmv_d_s_x";
...
double do_test_dgbmv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
 ...
 */
{
  ...
  double *head_r_true, *tail_r_true;
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_dgbmv_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_dgbmv_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			for (incy_val = -2; incy_val <= 2; incy_val++) {
			  ...
			  /* call BLAS_dgbmv */
			  FPU_FIX_STOP;
			  BLAS_dgbmv(order_type, trans_type, m, n, kl, ku,
				     alpha, AB, lda, x, incx_val, beta, y,
				     incy_val);
			  FPU_FIX_START;
...
double do_test_cgbmv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
 ...
 */
{
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_cgbmv_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_cgbmv_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			for (incy_val = -2; incy_val <= 2; incy_val++) {
			  ...
			  /* call BLAS_cgbmv */
			  FPU_FIX_STOP;
			  BLAS_cgbmv(order_type, trans_type, m, n, kl, ku,
				     alpha, AB, lda, x, incx_val, beta, y,
				     incy_val);
			  FPU_FIX_START;
			  ...
			  if (!(ratio <= thresh)) {
				...
				if (j < n_i) {
				  printf("      ");
				  printf("x[%d]=(%.8e, %.8e)", ix, x[ix],
					 x[ix + 1]);
				  printf("\n");
				}
				if (k < m_i) {
				  printf("      ");
				  printf("y_gen[%d]=(%.8e, %.8e)",
				...
				iy += incy;
			      ...
			      printf("      ");
			      printf("alpha=(%.8e, %.8e)", alpha[0],
				     alpha[1]);
			      printf("\n      ");
			      printf("beta=(%.8e, %.8e)", beta[0], beta[1]);
			      printf("\n");
			      for (j = 0; j < m_i; j++) {
				printf("      ");
				printf
		  ...
		  for (ku = 0; ku < n; ku++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  for (incy_val = -2; incy_val <= 2; incy_val++) {
			    ...
			    /* call BLAS_cgbmv_x */
			    FPU_FIX_STOP;
			    BLAS_cgbmv_x(order_type, trans_type, m, n, kl, ku,
					 alpha, AB, lda, x, incx_val, beta, y,
					 incy_val, prec_type);
			    FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_cgbmv_s_s";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_cgbmv_s_s_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_cgbmv_s_s_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_cgbmv_s_s_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
			...
			for (incy_val = -2; incy_val <= 2; incy_val++) {
			  ...
			  /* call BLAS_cgbmv_s_s */
			  FPU_FIX_STOP;
			  BLAS_cgbmv_s_s(order_type, trans_type, m, n, kl, ku,
					 alpha, AB, lda, x, incx_val, beta, y,
					 incy_val);
			  FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_cgbmv_s_s_x";
		  ...
		  for (ku = 0; ku < n; ku++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  for (incy_val = -2; incy_val <= 2; incy_val++) {
			    ...
			    FPU_FIX_STOP;
			    BLAS_cgbmv_s_s_x(order_type, trans_type, m, n, kl,
					     ku, alpha, AB, lda, x, incx_val,
					     beta, y, incy_val, prec_type);
			    FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_cgbmv_s_c";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_cgbmv_s_c_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_cgbmv_s_c_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_cgbmv_s_c_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
			...
			for (incy_val = -2; incy_val <= 2; incy_val++) {
			  ...
			  /* call BLAS_cgbmv_s_c */
			  FPU_FIX_STOP;
			  BLAS_cgbmv_s_c(order_type, trans_type, m, n, kl, ku,
					 alpha, AB, lda, x, incx_val, beta, y,
					 incy_val);
			  FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_cgbmv_s_c_x";
		  ...
		  for (ku = 0; ku < n; ku++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  for (incy_val = -2; incy_val <= 2; incy_val++) {
			    ...
			    FPU_FIX_STOP;
			    BLAS_cgbmv_s_c_x(order_type, trans_type, m, n, kl,
					     ku, alpha, AB, lda, x, incx_val,
					     beta, y, incy_val, prec_type);
			    FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_cgbmv_c_s";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_cgbmv_c_s_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_cgbmv_c_s_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_cgbmv_c_s_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
			...
			for (incy_val = -2; incy_val <= 2; incy_val++) {
			  ...
			  /* call BLAS_cgbmv_c_s */
			  FPU_FIX_STOP;
			  BLAS_cgbmv_c_s(order_type, trans_type, m, n, kl, ku,
					 alpha, AB, lda, x, incx_val, beta, y,
					 incy_val);
			  FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_cgbmv_c_s_x";
		  ...
		  for (ku = 0; ku < n; ku++) {
			...
			for (incx_val = -2; incx_val <= 2; incx_val++) {
			  ...
			  for (incy_val = -2; incy_val <= 2; incy_val++) {
			    ...
			    FPU_FIX_STOP;
			    BLAS_cgbmv_c_s_x(order_type, trans_type, m, n, kl,
					     ku, alpha, AB, lda, x, incx_val,
					     beta, y, incy_val, prec_type);
			    FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_c_c";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_zgbmv_c_c_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_zgbmv_c_c_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_zgbmv_c_c_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
			  ...
			  if (!(ratio <= thresh)) {
				...
				iy += incy;
			      ...
			      printf("alpha=(%.16e, %.16e)", alpha[0],
				     alpha[1]);
			      printf("\n      ");
			      printf("beta=(%.16e, %.16e)", beta[0], beta[1]);
			      printf("\n");
			      for (j = 0; j < m_i; j++) {
				printf("      ");
				printf
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_c_c_x";
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_c_z";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_zgbmv_c_z_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_zgbmv_c_z_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_zgbmv_c_z_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_c_z_x";
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_z_c";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_zgbmv_z_c_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_zgbmv_z_c_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_zgbmv_z_c_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_z_c_x";
...
double do_test_zgbmv(int m, int n,
		     int ntests,
		     int *seed,
		     double thresh,
		     int debug,
 ...
 */
{
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_zgbmv_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_zgbmv_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			for (incy_val = -2; incy_val <= 2; incy_val++) {
			  ...
			  /* call BLAS_zgbmv */
			  FPU_FIX_STOP;
			  BLAS_zgbmv(order_type, trans_type, m, n, kl, ku,
				     alpha, AB, lda, x, incx_val, beta, y,
				     incy_val);
			  FPU_FIX_START;
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_d_d";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_zgbmv_d_d_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_zgbmv_d_d_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_zgbmv_d_d_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_d_d_x";
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_z_d";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_zgbmv_z_d_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_zgbmv_z_d_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_zgbmv_z_d_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_z_d_x";
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_d_z";
  ...
  int alpha_val;
  int alpha_flag = 0;		/* input flag for BLAS_zgbmv_d_z_testgen */
  int beta_val;
  int beta_flag = 0;		/* input flag for BLAS_zgbmv_d_z_testgen */
  int order_val;
  enum blas_order_type order_type = 0;
		...
		for (ku = 0; ku < n; ku++) {
		  ...
		  for (kl = 0; kl < m; kl++) {
			...
			continue;
		      ...
		      /* in the trivial cases, no need to run testgen */
		      if (m > 0 && n > 0)
			BLAS_zgbmv_d_z_testgen(norm, order_type, trans_type,
					       m, n, kl, ku, &alpha,
					       alpha_flag, AB, lda, x_gen,
					       &beta, beta_flag, y_gen, seed,
					       head_r_true, tail_r_true);
...
{
  /* function name */
  const char fname[] = "BLAS_zgbmv_d_z_x";
...
int main(int argc, char **argv)
{
  ...
  if (argc != 6) {
    printf("Usage:\n");
    printf("do_test_gbmv <nsizes> <ntests> <thresh> <debug> <test_prob>\n");
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_sgbmv(m, n, 1, &seed, thresh, debug,
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_dgbmv(m, n, 1, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_zgbmv(m, n, 1, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
  ...
  for (i = 0; i < nsizes; i++) {
    m = mn_pairs[i][0];
    n = mn_pairs[i][1];
    total_max_ratio = do_test_cgbmv(m, n, 1, &seed, thresh, debug,
				    test_prob, &total_min_ratio,
				    &num_bad_ratio, &num_tests);
    if (total_max_ratio > max_ratio)
      max_ratio = total_max_ratio;
