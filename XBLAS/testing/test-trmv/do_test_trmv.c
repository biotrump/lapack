...
double do_test_strmv(int n, int ntests, int *seed,
 ...
 */
{
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			ixgen += inc_xgen;
		      ...
		      /* call BLAS_strmv */
		      FPU_FIX_STOP;
		      BLAS_strmv(order_type, uplo_type, trans_type,
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_strmv */


double do_test_dtrmv(int n, int ntests, int *seed,
		     double thresh, int debug, float test_prob,
		     double *min_ratio, int *num_bad_ratio, int *num_tests)
 ...
 */
{
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			ixgen += inc_xgen;
		      ...
		      /* call BLAS_dtrmv */
		      FPU_FIX_STOP;
		      BLAS_dtrmv(order_type, uplo_type, trans_type,
				 diag_type, n, alpha, T, lda, x, incx_val);
		      FPU_FIX_START;
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_dtrmv */


double do_test_ctrmv(int n, int ntests, int *seed,
		     double thresh, int debug, float test_prob,
		     double *min_ratio, int *num_bad_ratio, int *num_tests)
 ...
 */
{
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			ixgen += inc_xgen;
		      ...
		      /* call BLAS_ctrmv */
		      FPU_FIX_STOP;
		      BLAS_ctrmv(order_type, uplo_type, trans_type,
				 diag_type, n, alpha, T, lda, x, incx_val);
		      FPU_FIX_START;
  ...
  *num_tests = tot_tests;
  return ratio_max;
}				/* end of do_test_ctrmv */


double do_test_ztrmv(int n, int ntests, int *seed,
		     double thresh, int debug, float test_prob,
		     double *min_ratio, int *num_bad_ratio, int *num_tests)
		...
		for (i = 0; i < ntests; i++) {
		  ...
		  for (lda_val = 0; lda_val < 3; lda_val++) {
			...
			ixgen += inc_xgen;
		      ...
		      /* call BLAS_ztrmv */
		      FPU_FIX_STOP;
		      BLAS_ztrmv(order_type, uplo_type, trans_type,
				 diag_type, n, alpha, T, lda, x, incx_val);
		      FPU_FIX_START;
			...
			if (debug == 3) {
			  ...
			  for (j = 0; j < n; j++) {
			    ...
			    if (j > 0)
			      printf("        ");
			    for (k = 0; k < n * incT; k += incT) {
			      printf("(%.16e+ %.16ei)", temp[k], temp[k + 1]);
			      printf("  ");
			    }
			    printf("\n");
			  }
...
int main(int argc, char **argv)
{
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_strmv(n, ntests, &seed,
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_dtrmv(n, ntests, &seed,
				    thresh, debug, test_prob,
				    &total_min_ratio, &num_bad_ratio,
				    &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ctrmv(n, ntests, &seed,
				    thresh, debug, test_prob,
				    &total_min_ratio, &num_bad_ratio,
				    &num_tests);
    if (total_max_ratio > max_ratio)
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    n = sizes[i];
    total_max_ratio = do_test_ztrmv(n, ntests, &seed,
				    thresh, debug, test_prob,
				    &total_min_ratio, &num_bad_ratio,
				    &num_tests);
    if (total_max_ratio > max_ratio)
